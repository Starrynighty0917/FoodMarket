# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-07-02 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market_price', models.FloatField(blank=True, default=0.0, null=True, verbose_name='市场价格')),
                ('shop_price', models.FloatField(default=0.0, verbose_name='本店价格')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='media/', verbose_name='商品封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父级商品类型', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父级商品类型')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.AddField(
            model_name='banner',
            name='goods',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods', verbose_name='轮播图货物'),
        ),
    ]
